  ...
  return (
    <div className="main">
      <div className="container">
        <div className="text">
          <div className="title">Why choose Easybank?</div>
          <div className="description">
            We leverage Open Banking to turn your bank account into your finalcial
            ...
            <div className="row justify-content-between">
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 items">
                ...
                <div className="text">
                  ...
                  <div className="title">
                    <a href="#">Recevie money in any currency with no fees</a>
                  </div>
                  <div className="description">
              ...
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 items">
                ...
                <div className="text">
                  ...
                  <div className="title">
                  <a href="#">Treat yourself withour worrying about money</a>
                  </div>
                  <div className="description">
                    Our simple budgeting feature allows you to separate out your
                    spending and set realistic limits each month. That mean you...
                  </div>
                </div>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 items">
